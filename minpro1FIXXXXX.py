...
buket = ["Rosey Rose", "Majestic Lily", "Harmony of Pink Bloom", 
        "Rise and Shine", "Daisy Daze", "Beautiful in White", "Tulip in Your Eyes"] #list paket bouquet

addon = ["Bunga Mawar", "Bunga Matahari", "Bunga Lily", 
        "Bunga Tulip", "Bunga Daisy", "Tidak Custom"] #list custom add on bunga

kertas = ["Putih", "Hitam", "Coklat", "Pink"] #list wrapping paper

status = ["Belum dikerjakan", "Dalam proses pembuatan", "Selesai"] #list status orderan

order0 = ["Haur", "081333637409", "Harmony of Pink Bloom", "Bunga Mawar", "Putih", "Belum dikerjakan", "20-09-2025"] #contoh orderan
...
order4 = ["Alip", "082136984447", "Beautiful in White", "Bunga Mawar", "Putih", "Dalam proses pembuatan", "24-09-2025"]
...
#MENU4 HAPUS ORDERAN
    ...
    if len(orderan) == 0:
        ...
        if 0 <= delete <= 4:
            ...
            print("YAYYY! Orderan berhasil dihapus :D")
        else:
            print("Pilihan kamu tidak valid! :(")
            exit()
